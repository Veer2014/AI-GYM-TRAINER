...
def main():
    ...
    st.set_page_config(page_icon="🏋🏻‍♂️",page_title="AI GYM Trainer", initial_sidebar_state="expanded", layout="centered")
    ...
    with st.sidebar:
        ...
        if workout_started:
            ...
            st.metric("Current reps", f"{current_set_reps} / {reps_per_set}")
    ...
    if not workout_started:
        st.markdown(
            ...
            <div style="
                ...
                margin-top: 32px;
            ">    
                <h2 style="color:#ccc; margin-botton:8px;">👈Set your Workout Plan</h2>
